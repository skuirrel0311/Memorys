Shader "Instanced/Floor" {
	Properties {
		_Color ("Color", Color) = (1,1,1,1)
		_MainTex ("Albedo (RGB)", 2D) = "white" {}
		_BumpMap("NormalMap", 2D) = "white" {} 
		[NoScaleOffset]
		_EmitTex("Emit",2D) = "white"{}
		_EmitColor("EmitColor", Color) = (0,0,0,1)
		_EmitPow("EmitPow",Float) = 1.0
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			o.Emission = tex2D(_EmitTex, IN.uv_MainTex)*_EmitColor*_EmitPow;
			o.Alpha = c.a;
		}
		ENDCG
	}
